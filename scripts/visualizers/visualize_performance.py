...
output_path = output_dir / 'extraction_performance_visualization.png'
...
# 保存简化图
simple_output_path = output_dir / 'key_improvements_visualization.png'
plt.savefig(simple_output_path, dpi=300, bbox_inches='tight')
print(f"简化图表已保存到: {simple_output_path}")
